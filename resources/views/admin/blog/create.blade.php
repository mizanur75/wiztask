        ...
        <div class="col-md-12">
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                <label for="exampleFormControlSelect1" class="form-label">Category</label>
                <select class="form-select" id="exampleFormControlSelect1" name="sub_category_id" aria-label="Default select example">
                  <option selected="false" disabled>Select Sub Category</option>
              ...
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Blog Details</label>
